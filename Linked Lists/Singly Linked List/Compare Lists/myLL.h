...
public:
	...
	bool compareLinkedLists(LinkedList& otherList) override;
};
...
bool myLL::compareLinkedLists(LinkedList& otherList) 
{
	Node* temp1 = head;
	...
	return true; // All values matched and both lists ended
}